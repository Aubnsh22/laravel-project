...
<div class="main-content">
  <div class="tasks-container">
    ...
    <div class="hero-section">
      <h1 class="fw-bold mb-3">Task Management<br>Overview</h1>
      <button class="btn btn-dark fw-semibold me-3">Create Task</button>
      <button class="btn btn-outline-dark fw-semibold">Export Tasks</button>
    </div>

    <div class="tasks-section">
      <h4 class="mb-4">Task List</h4>
